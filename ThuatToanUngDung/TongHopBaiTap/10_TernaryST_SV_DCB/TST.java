...
public class TST<Value> {
    ...
    protected Node<Value> root;   // root of TST

    protected static class Node<Value> {
        protected char c;                        // character
        protected Node<Value> left, mid, right;  // left, middle, and right subtries
        protected Value val;                     // value associated with string
    }
    ...
    protected void collect(Node<Value> x, StringBuilder prefix, Queue<String> queue) {
        if (x == null) return;
