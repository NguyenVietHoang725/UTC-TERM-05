 ...
 *  Dependencies: SuffixArrayXVN.java VietnameseAlphabet.java In.java StdOut.java
 ...
 *  appears in both texts, with support for Vietnamese alphabet.
 *
...
/**
 *  The {@code LongestCommonSubstring} class provides a {@link SuffixArrayXVN}
 *  client for computing the longest common substring that appears in two
 *  given strings, with support for Vietnamese characters.
 *  <p>
 *  This implementation computes the suffix array of each string using the Vietnamese alphabet
 *  and applies a merging operation to determine the longest common substring.
